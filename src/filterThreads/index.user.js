...
(function() {
    ...
    $('head').append(`
		<style>
			#${DIALOG_ID} .swal2-textarea {
				font-size: 100% !important;
				resize: vertical !important;
			}
			#${DIALOG_ID} .swal2-checkbox {
				margin-right: 5px !important;
			}
			#${DIALOG_ID} .swal2-textarea, .swal2-checkbox, .swal2-label {
